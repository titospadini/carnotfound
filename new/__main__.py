...
x_ROI1, y_ROI1 = [ROI_WIDTH/2 (ROI_HEIGTH/8)*3]
x_ROI2, y_ROI2 = [ROI_WIDTH/2 (ROI_HEIGTH/8)*5]
x_ROI3, y_ROI3 = [ROI_WIDTH/2 (ROI_HEIGTH/8)*7]

x_ROI1_a, y_ROI1_a = [ROI_WIDTH/2 (ROI_HEIGTH/8)*3]
x_ROI2_a, y_ROI2_a = [ROI_WIDTH/2 (ROI_HEIGTH/8)*5]
x_ROI3_a, y_ROI3_a = [ROI_WIDTH/2 (ROI_HEIGTH/8)*7]
